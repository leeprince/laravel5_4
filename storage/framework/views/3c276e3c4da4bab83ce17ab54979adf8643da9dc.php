<div class="panel-body">
    <form class="form-horizontal" method='POST' action="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" name='name'  class="form-control" id="name" value="<?php echo e(old('name')); ?>"" placeholder="请输入学生姓名">
            </div>
            <div class="col-sm-5">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" name='age' class="form-control" id="age" value="<?php echo e(old('age')); ?>" placeholder="请输入学生年龄">
            </div>
            <div class="col-sm-5">
